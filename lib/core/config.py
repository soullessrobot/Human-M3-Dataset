...
config.NETWORK.PARAMETER_IMAGE_SIZE = np.array([320, 320])
...
config.NETWORK.USE_PCD = False
config.NETWORK.USE_RGB = True
config.NETWORK.INPUT_HM = True
config.NETWORK.FUSION_TYPE = 'concat_hm' #'mask', 'trans', 'concat_feat'
config.NETWORK.FEAT_CHANNEL = 256
config.NETWORK.PROJECT_TYPE = 'heatmap' #'feature'
...
config.DATASET.ROOT_POSE2D = '../data/h36m/pose2d'
